...
release_state_reset_vars() {
    ...
    REMOTE_MAIN_PUSHED="${REMOTE_MAIN_PUSHED:-0}"
    REMOTE_TAG_PUSHED="${REMOTE_TAG_PUSHED:-0}"
    GITHUB_RELEASE_DRAFT_CREATED="${GITHUB_RELEASE_DRAFT_CREATED:-0}"
...
REMOTE_MAIN_PUSHED=$REMOTE_MAIN_PUSHED
REMOTE_TAG_PUSHED=$REMOTE_TAG_PUSHED
GITHUB_RELEASE_DRAFT_CREATED=$GITHUB_RELEASE_DRAFT_CREATED
...
release_state_init() {
    ...
    RELEASE_COMMIT=""
    LOCAL_TAG_CREATED=0
    REMOTE_MAIN_PUSHED=0
    REMOTE_TAG_PUSHED=0
    GITHUB_RELEASE_DRAFT_CREATED=0
    CRATE_PUBLISHED=0
