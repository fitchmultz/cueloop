...
## Done
- [x] RQ-0497 [code]: Change default log path to PWD .ralph/logs/ralph.log. (ralph_tui/internal/config, ralph_tui/cmd/ralph/main.go)
...
- [x] RQ-0496 [code]: Change default ralph data directory to PWD .ralph/data instead of PWD data/. (ralph_tui/internal/config, ralph_tui/cmd/ralph/main.go)
