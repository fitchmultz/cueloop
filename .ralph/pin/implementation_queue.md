...
## Queue
- [ ] RQ-0301 [ui]: Simplify focus and keybindings (Tab focus, Ctrl+T pin pane, E specs settings, F logs format). (ralph_tui/internal/tui/model.go, ralph_tui/internal/tui/keymap.go, ralph_tui/internal/tui/help_keymap.go, ralph_tui/internal/tui/pin_view.go)
