...
- Current highest-value remaining suite candidate is `task_template_commands_test.rs`; revisit subsequent structural targets only if fresh profiling points elsewhere.
