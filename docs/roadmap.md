...
### 1. Split the remaining oversized macOS persistence and parsing suites after the lifecycle audit settles
...
### 2. Extend supervision hardening to parallel-worker and revert-mode edge cases
