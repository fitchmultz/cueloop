...
- For release-quality verification, run `make macos-ci` when app changes are in scope; it now includes deterministic noninteractive Settings contract coverage alongside the standard app build/tests.
