/**
 ...
 Does not handle:
 - Functional testing (see CueLoopMacUITests).
...
@MainActor
final class CueLoopMacUITestsLaunchTests: XCTestCase {
    ...
    func testLaunch() throws {
        ...
        let screenshotsEnabled = environment["CUELOOP_UI_SCREENSHOTS"] == "1"
            || (environment["CUELOOP_UI_SCREENSHOT_MODE"]?.lowercased() != nil
                && environment["CUELOOP_UI_SCREENSHOT_MODE"]?.lowercased() != "off")
