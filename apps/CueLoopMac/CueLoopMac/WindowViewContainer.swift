...
struct WindowViewContainer: View {
    ...
    private static let uiTestingWorkspacePathEnvKey = "CUELOOP_UI_TEST_WORKSPACE_PATH"
    private static let settingsSmokeWorkspacePathEnvKey = "CUELOOP_SETTINGS_SMOKE_WORKSPACE_A"
    private static let workspaceRoutingWorkspacePathEnvKey = "CUELOOP_WORKSPACE_ROUTING_CONTRACT_WORKSPACE_A"
