...
struct KanbanBoardView: View {
    ...
    @State private var focusedColumnStatus: CueLoopTaskStatus = .todo
    ...
    private func handleTaskDrop(taskID: String, to status: CueLoopTaskStatus) {
        // Find the task
    ...
    private func navigateColumn(direction: Int) {
        let statuses = CueLoopTaskStatus.allCases
