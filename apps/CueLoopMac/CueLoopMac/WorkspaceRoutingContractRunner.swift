...
final class WorkspaceRoutingContractRunner {
    ...
    private enum EnvironmentKey {
        static let workspaceA = "CUELOOP_WORKSPACE_ROUTING_CONTRACT_WORKSPACE_A"
        static let workspaceB = "CUELOOP_WORKSPACE_ROUTING_CONTRACT_WORKSPACE_B"
        static let workspaceC = "CUELOOP_WORKSPACE_ROUTING_CONTRACT_WORKSPACE_C"
        static let reportPath = "CUELOOP_WORKSPACE_ROUTING_CONTRACT_REPORT_PATH"
    }
    ...
    func configureIfNeeded() {
        guard CueLoopAppDefaults.isWorkspaceRoutingContract else { return }
    ...
    private func runContract(_ configuration: Configuration) async throws -> WorkspaceRoutingContractReport {
        ...
        CueLoopURLRouter.handle(workspaceOpenURL(for: configuration.workspaceBURL, scheme: "cueloop"))
