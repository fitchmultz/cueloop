...
struct TaskListFilterControls: View {
    ...
    private var statusFilterBinding: Binding<CueLoopTaskStatus?> {
        Binding(
    ...
    private var priorityFilterBinding: Binding<CueLoopTaskPriority?> {
        Binding(
...
enum TaskListPalette {
    static func statusColor(_ status: CueLoopTaskStatus) -> Color {
        switch status {
        case .draft:
            return .gray
        case .todo:
    ...
    static func priorityColor(_ priority: CueLoopTaskPriority) -> Color {
        switch priority {
        case .critical:
            return .red
        case .high:
