...
struct TemplateInfo: Identifiable, Equatable {
  ...
  let defaultPriority: CueLoopTaskPriority
...
struct TaskCreationView: View {
  ...
  @State private var priority: CueLoopTaskPriority = .medium
  ...
  @State private var createdTasks: [CueLoopTask] = []
    ...
    Form {
      Section("Request") {
        TextEditor(text: $aiRequest)
          ...
          .accessibilityHint("Describe the task or task set CueLoop should create")
    ...
    Form {
      Section {
        ...
        Picker("Priority", selection: $priority) {
          ForEach(CueLoopTaskPriority.allCases, id: \.self) { p in
            HStack {
              Circle()
  ...
  private func priorityColor(_ priority: CueLoopTaskPriority) -> Color {
    switch priority {
