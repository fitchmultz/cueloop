...
class AppDelegate: NSObject, NSApplicationDelegate {
    ...
    func applicationDidFinishLaunching(_ notification: Notification) {
        NSApp.setActivationPolicy(CueLoopMacPresentationRuntime.activationPolicy)
    ...
    private func isWorkspaceWindow(_ window: NSWindow) -> Bool {
        ...
        // Only CueLoop workspace windows participate in the app-level placement flow.
    ...
    private func applyRevealFrame(_ frame: NSRect, to window: NSWindow) {
        CueLoopMacPresentationRuntime.applyRevealFrame(frame, to: window)
    }
}
