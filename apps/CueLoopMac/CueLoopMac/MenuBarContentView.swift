...
struct MenuBarContentView: View {
    ...
    @AppStorage(MenuBarManager.visibilityDefaultsKey, store: CueLoopAppDefaults.userDefaults)
    ...
    /// App-level actions (Open CueLoop, Settings, Quit)
    @ViewBuilder
    ...
    private func taskCounts(from tasks: [CueLoopTask]) -> (todo: Int, doing: Int, done: Int) {
        (
    ...
    private func getRecentTasks(from tasks: [CueLoopTask], limit: Int) -> [CueLoopTask] {
        tasks
...
struct PriorityBadge: View {
    let priority: CueLoopTaskPriority
