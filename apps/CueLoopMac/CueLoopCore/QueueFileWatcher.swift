    ...
    public struct WatchTargets: Sendable, Equatable {
        ...
        public static func `default`(for workingDirectoryURL: URL) -> WatchTargets {
            ...
            return WatchTargets(
                ...
                queueFileURL: baseURL.appendingPathComponent(".cueloop/queue.jsonc", isDirectory: false),
                doneFileURL: baseURL.appendingPathComponent(".cueloop/done.jsonc", isDirectory: false),
                projectConfigFileURL: baseURL.appendingPathComponent(".cueloop/config.jsonc", isDirectory: false)
            )
        }
