...
public struct WorkspaceTaskPresentation: Sendable {
    ...
    public let tasksByStatus: [CueLoopTaskStatus: [CueLoopTask]]

    public init(tasks: [CueLoopTask]) {
        self.tasks = tasks
...
public extension Workspace {
    ...
    func filteredAndSortedTasks() -> [CueLoopTask] {
        taskPresentation().tasks
    }

    private func compareTasks(_ lhs: CueLoopTask, _ rhs: CueLoopTask) -> ComparisonResult {
