/**
 ...
 Purpose:
 - Provide Codable models for CueLoop configuration parsing and serialization.
 ...
 Does not handle:
 - CLI operations (see CueLoopCLIClient).
...
/// Subset of CLI `WebhookConfig` needed for CueLoopCore decoding of `machine config resolve` payloads.
...
public struct CueLoopConfig: Codable, Sendable, Equatable {
...
public struct MachineSystemInfoDocument: Codable, Sendable, Equatable, VersionedMachineDocument {
    public static let expectedVersion = CueLoopMachineContract.systemInfoVersion
...
public struct MachineErrorDocument: Codable, Sendable, Equatable, VersionedMachineDocument {
    public static let expectedVersion = CueLoopMachineContract.errorVersion
    ...
    public static func decodeIfPresent(
        ...
        do {
            return try CueLoopMachineContract.decode(
...
public struct MachineConfigResolveDocument: Codable, Sendable, Equatable, VersionedMachineDocument {
    public static let expectedVersion = CueLoopMachineContract.configResolveVersion
    ...
    public let config: CueLoopConfig
...
public struct MachineWorkspaceOverviewDocument: Codable, Sendable, Equatable, VersionedMachineDocument {
    public static let expectedVersion = CueLoopMachineContract.workspaceOverviewVersion
...
struct MachineParallelStatusDocument: Decodable, Sendable, Equatable, VersionedMachineDocument {
    static let expectedVersion = CueLoopMachineContract.parallelStatusVersion
...
struct MachineDoctorReportDocument: Decodable, Sendable, Equatable, VersionedMachineDocument {
    static let expectedVersion = CueLoopMachineContract.doctorReportVersion
    static let documentName = "machine doctor report"

    let version: Int
    let blocking: WorkspaceRunnerController.MachineBlockingState?
    let report: CueLoopJSONValue
}
