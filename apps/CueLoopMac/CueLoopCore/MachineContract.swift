/**
 ...
 Purpose:
 - Centralize CueLoopMac validation for versioned machine JSON documents emitted by the CLI.
  ...
  public static func requireVersion(
    ...
    guard actual == expected else {
      throw RecoveryError(
        ...
        message:
          "Unsupported \(document) version \(actual). CueLoopMac requires version \(expected).",
        operation: operation,
