    ...
    public static func persist<Snapshot: Codable>(
        ...
        do {
            ...
            if let failureTelemetry {
                ...
                CueLoopLogger.shared.error(telemetry.message, category: .workspace)
            }
...
public enum WorkspaceDiagnosticsService {
    public static func queueValidationOutput(for workspace: Workspace) async -> String {
        ...
        case .configResolutionFailed(let recoveryError):
            ...
            CueLoopMac could not resolve the workspace queue paths before validation.
    ...
    public static func recentLogs(hours: Int = 2) async -> String {
        ...
        do {
            return try await CueLoopLogger.shared.exportLogs(hours: hours)
        } catch {
...
private extension CueLoopJSONValue {
