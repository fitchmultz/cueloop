...
//!
//! Purpose:
//! - Coordinate the domain-specific state owners that represent one CueLoop workspace.
//!
//! Responsibilities:
...
public final class Workspace: ObservableObject, Identifiable {
    ...
    public func injectClient(_ client: CueLoopCLIClient) {
    ...
    public func nextTask() -> CueLoopTask? {
    ...
    public func isTaskBlocked(_ task: CueLoopTask) -> Bool {
    ...
    public func isTaskOverdue(_ task: CueLoopTask) -> Bool {
...
extension Workspace {
    func performRepositoryLoad<Value>(
        ...
        load: @escaping @Sendable (CueLoopCLIClient, URL, RetryConfiguration) async throws -> Value,
    ...
    func collectRepositoryCommand(
        ...
        retryConfiguration: RetryConfiguration,
        onRetry: RetryProgressHandler? = nil
    ) async throws -> CueLoopCLIClient.CollectedOutput {
