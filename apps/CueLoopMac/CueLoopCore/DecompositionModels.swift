...
public struct TaskDecomposeOptions: Sendable, Equatable {
    ...
    public init(
        ...
        maxChildren: Int = 5,
        maxNodes: Int = 50,
        status: CueLoopTaskStatus = .draft,
...
public enum DecompositionSource: Sendable, Equatable {
    ...
    case existingTask(task: CueLoopTask)
...
extension DecompositionSource: Decodable {
    ...
    public init(from decoder: any Decoder) throws {
        ...
        case .existingTask:
            self = .existingTask(task: try container.decode(CueLoopTask.self, forKey: .task))
        case .planFile:
...
public struct DecompositionPreview: Decodable, Sendable, Equatable {
    ...
    public let childStatus: CueLoopTaskStatus
...
struct MachineDecomposeDocument: Decodable, Sendable, Equatable, VersionedMachineDocument {
    static let expectedVersion = CueLoopMachineContract.taskDecomposeVersion
