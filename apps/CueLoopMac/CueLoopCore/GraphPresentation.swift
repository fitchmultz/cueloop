...
public struct CueLoopGraphPresentation: Sendable, Equatable {
...
public enum CueLoopGraphPresentationBuilder {
    public static func build(
        graphData: CueLoopGraphDocument,
        tasks: [CueLoopTask],
        selectedTaskID: String?
    ) -> CueLoopGraphPresentation {
        ...
        return CueLoopGraphPresentation(
            nodes: nodes,
            edges: edges,
    ...
    private static func buildNodes(tasks: [CueLoopGraphNode], selectedTaskID: String?) -> [PositionedNode] {
    ...
    private static func buildEdges(graphData: CueLoopGraphDocument, tasks: [CueLoopTask]) -> [GraphEdge] {
        var edges: [GraphEdge] = []
