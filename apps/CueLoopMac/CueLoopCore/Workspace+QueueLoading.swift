...
//!
//! Usage:
//! - Used by the CueLoop macOS app or CueLoopCore tests through its owning feature surface.
...
public final class WorkspaceTaskState: ObservableObject {
    @Published public var tasks: [CueLoopTask] = []
    ...
    @Published public var taskStatusFilter: CueLoopTaskStatus?
    @Published public var taskPriorityFilter: CueLoopTaskPriority?
...
public extension Workspace {
    ...
    struct QueueRefreshEvent: Identifiable, Sendable, Equatable {
        ...
        public let previousTasks: [CueLoopTask]
        public let currentTasks: [CueLoopTask]
        public let highlightedTaskIDs: Set<String>

        public init(
            id: UUID = UUID(),
            source: Source,
            previousTasks: [CueLoopTask],
            currentTasks: [CueLoopTask]
        ) {
...
extension Workspace {
    ...
    private func workspaceOverviewCapability(
        ...
        do {
            ...
            guard document.spec.version == CueLoopCLISpecDocument.expectedVersion else {
                return .unknown
            }
