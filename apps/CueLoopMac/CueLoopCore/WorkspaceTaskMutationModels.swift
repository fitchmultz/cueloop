/**
 ...
 - Unknown machine payload bodies remain in `CueLoopJSONValue` instead of being dropped.
 */
...
struct MachineQueueValidateDocument: Decodable, Sendable, Equatable, VersionedMachineDocument {
  static let expectedVersion = CueLoopMachineContract.queueValidateVersion
...
struct MachineQueueRepairDocument: Decodable, Sendable, Equatable, VersionedMachineDocument {
  static let expectedVersion = CueLoopMachineContract.queueRepairVersion
...
struct MachineQueueUndoDocument: Decodable, Sendable, Equatable, VersionedMachineDocument {
  static let expectedVersion = CueLoopMachineContract.queueUndoVersion
...
struct MachineRunStopDocument: Decodable, Sendable, Equatable, VersionedMachineDocument {
  static let expectedVersion = CueLoopMachineContract.runStopVersion
...
struct MachineQueueUnlockInspectDocument: Decodable, Sendable, Equatable, VersionedMachineDocument {
  static let expectedVersion = CueLoopMachineContract.queueUnlockInspectVersion
...
struct MachineTaskCreateDocument: Codable, Sendable, VersionedMachineDocument {
  static let expectedVersion = CueLoopMachineContract.taskCreateVersion
...
struct MachineTaskBuildRequest: Codable, Sendable {
  ...
  init(
    version: Int = CueLoopMachineContract.taskBuildVersion,
    request: String,
    tags: [String],
    scope: [String],
    template: String?,
...
struct MachineTaskBuildDocument: Decodable, Sendable, VersionedMachineDocument {
  static let expectedVersion = CueLoopMachineContract.taskBuildVersion
...
struct MachineTaskMutationDocument: Decodable, Sendable, VersionedMachineDocument {
  static let expectedVersion = CueLoopMachineContract.taskMutateVersion
