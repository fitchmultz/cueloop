/**
 ...
 Does not handle:
 - Executing the CLI (see CueLoopCLIClient).
...
public enum VersionCompatibility {
    ...
    public static let minimumCLIVersion = "0.4.1"
    /// Maximum supported CLI version (inclusive).
    public static let maximumCLIVersion = "0.4.1"
...
public struct VersionValidator: Sendable, Equatable {
    ...
    public struct VersionCheckResult: Sendable, Equatable {
        ...
        public var guidanceMessage: String? {
            ...
            return "Please reinstall CueLoop to ensure the CLI and app versions match. The bundled CLI should be in CueLoopMac.app/Contents/MacOS/cueloop"
        }
    }
