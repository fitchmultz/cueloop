...
public final class ConsoleOutputBuffer: Sendable {
    ...
    private static let defaultsKey = "com.mitchfultz.cueloop.consoleOutputBuffer.maxCharacters"
    /// UserDefaults key for truncation indicator persistence
    private static let indicatorDefaultsKey = "com.mitchfultz.cueloop.consoleOutputBuffer.truncationIndicator"
