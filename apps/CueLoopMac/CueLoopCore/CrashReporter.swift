...
struct CrashReportStorage: Sendable {
    ...
    static let live = CrashReportStorage(
        directoryURL: {
            ...
            return appSupport.appendingPathComponent("CueLoop/CrashReports", isDirectory: true)
        },
...
public final class CrashReporter: ObservableObject {
    ...
    public func install() {
        ...
        pruneOldReports()
        CueLoopLogger.shared.info("Crash reporter installed", category: .crashReporting)
    }
    ...
    public func clearAllReports() {
        ...
        do {
            ...
            CueLoopLogger.shared.info("Cleared all crash reports", category: .crashReporting)
        } catch {
            recordIssue(
                PersistenceIssue(
                    domain: .crashReporting,
