/**
 ...
 - Apply a user's merge selections to produce a resolved `CueLoopTask`.
...
public enum TaskConflictField: String, CaseIterable, Identifiable, Sendable {
    ...
    public func differs(local: CueLoopTask, external: CueLoopTask) -> Bool {
        switch self {
        case .title:
    ...
    public func formattedValue(in task: CueLoopTask) -> String {
        switch self {
        case .title:
            return task.title
        case .description:
    ...
    public func applyLocalValue(from local: CueLoopTask, into resolved: inout CueLoopTask) {
        switch self {
        case .title:
    ...
    private static func formatAgent(_ agent: CueLoopTaskAgent?) -> String {
...
public struct TaskConflictResolutionModel: Sendable, Equatable {
    ...
    public init(localTask: CueLoopTask, externalTask: CueLoopTask) {
    ...
    public func applySelections(_ selections: [TaskConflictField: TaskConflictMergeChoice]) -> CueLoopTask {
    ...
    public static func applySelections(
        localTask: CueLoopTask,
        externalTask: CueLoopTask,
