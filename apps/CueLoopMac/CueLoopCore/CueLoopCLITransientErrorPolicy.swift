/**
 CueLoopCLITransientErrorPolicy
 ...
 Usage:
 - `RetryHelper` and `CueLoopCLIRecoveryClassifier` call this module.
...
enum CueLoopCLITransientSignal: Equatable {
    case resourceBusy
    case networkError
}

enum CueLoopCLITransientErrorPolicy {
    ...
    private static let transientPatterns: [(needle: String, signal: CueLoopCLITransientSignal)] = [
    ...
    static func transientSignal(in text: String) -> CueLoopCLITransientSignal? {
