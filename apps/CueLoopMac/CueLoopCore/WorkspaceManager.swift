...
public final class WorkspaceManager: ObservableObject {
    ...
    public internal(set) var client: CueLoopCLIClient?

    let restorationKey = "com.mitchfultz.cueloop.windowRestorationState"
    let versionCheckCacheKey = "com.mitchfultz.cueloop.versionCheckCache"
    ...
    private init() {
        let preparation = CueLoopAppDefaults.prepareForLaunch()
