/**
 ...
 Purpose:
 - Expose narrowly scoped test-only accessors over internal Workspace state for CueLoopCore tests.
...
extension Workspace {
    ...
    var lastExitStatus: CueLoopCLIExitStatus? {
