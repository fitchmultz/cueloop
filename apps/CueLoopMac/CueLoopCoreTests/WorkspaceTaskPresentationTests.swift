...
@MainActor
final class WorkspaceTaskPresentationTests: CueLoopCoreTestCase {
    func testTaskPresentation_prioritySortIsDeterministicAscendingAndDescending() {
        let workspace = Workspace(workingDirectoryURL: CueLoopCoreTestSupport.workspaceURL(label: "task-presentation-priority"))
        let timestamp = Date(timeIntervalSince1970: 1_700_000_000)

        workspace.taskState.tasks = [
            CueLoopTask(id: "RQ-003", status: .todo, title: "Same", priority: .high, tags: [], createdAt: timestamp, updatedAt: timestamp),
            CueLoopTask(id: "RQ-001", status: .todo, title: "Same", priority: .high, tags: [], createdAt: timestamp, updatedAt: timestamp),
            CueLoopTask(id: "RQ-002", status: .todo, title: "Same", priority: .high, tags: [], createdAt: timestamp, updatedAt: timestamp),
        ]
    ...
    func testTaskPresentation_groupsTasksByStatusWithoutReorderingColumns() {
        let workspace = Workspace(workingDirectoryURL: CueLoopCoreTestSupport.workspaceURL(label: "task-presentation-grouping"))
        workspace.taskState.tasks = [
            CueLoopTask(id: "RQ-010", status: .doing, title: "Doing B", priority: .medium, tags: [], createdAt: Date(timeIntervalSince1970: 20), updatedAt: Date(timeIntervalSince1970: 20)),
            CueLoopTask(id: "RQ-002", status: .todo, title: "Todo A", priority: .medium, tags: [], createdAt: Date(timeIntervalSince1970: 10), updatedAt: Date(timeIntervalSince1970: 10)),
            CueLoopTask(id: "RQ-011", status: .doing, title: "Doing A", priority: .medium, tags: [], createdAt: Date(timeIntervalSince1970: 15), updatedAt: Date(timeIntervalSince1970: 15)),
        ]
