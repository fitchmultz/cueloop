/**
 CueLoopCoreTestSupport+Filesystem

 Purpose:
 - Centralize deterministic temp-directory, workspace-path, and cleanup helpers for CueLoopCore tests.
...
extension CueLoopCoreTestSupport {
    private static var tempRootName: String { "cueloop-core-tests" }
    ...
    static func resetPersistentTestState() {
        CueLoopAppDefaults.resetUnitTestingDefaults()
    }
