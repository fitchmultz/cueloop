...
@MainActor
final class WorkspaceTaskDecomposeTests: CueLoopCoreTestCase {
    ...
    private static func makeMockCLIFixture(
        ...
        let fixture = try CueLoopMockCLITestSupport.makeFixture(
            prefix: "cueloop-workspace-decompose",
        ...
        if let decomposeFailureDocument {
            errorURL = try CueLoopMockCLITestSupport.writeJSONDocument(
    ...
    private static let previewJSON = """
    {
      ...
      "continuation": {
        ...
        "detail": "CueLoop planned a task tree that can be written when you are ready.",
        "blocking": null,
        "next_steps": [
          {
