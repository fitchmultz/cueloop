/**
 ...
 Purpose:
 - Validate NavigationViewModel persistence via CueLoopAppDefaults.
 ...
 - Navigation state persistence uses CueLoop's isolated app defaults suite.
...
final class NavigationViewModelTests: CueLoopCoreTestCase {
    private let testNavigationKey = "com.mitchfultz.cueloop.navigationState"
