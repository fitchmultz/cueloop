/**
 ...
 Purpose:
 - Keep CrashReporterTests behavior scoped to its owning CueLoopMac feature.
...
/*
 Purpose:
 - Exercise crash-report storage, formatting, and operational-issue behavior in CueLoopCore tests.
 ...
 - Keep crash-report test fixture setup and teardown isolated through CueLoopCore test support.
 ...
 - Temporary report directories must be created through CueLoopCore test support and removed during teardown.
 */
...
@MainActor
final class CrashReporterTests: CueLoopCoreTestCase {
    private var reportsDirectory: URL!

    override func setUp() async throws {
        try await super.setUp()
        reportsDirectory = try CueLoopCoreTestSupport.makeTemporaryDirectory(prefix: "cueloop-crash-tests")
    ...
    override func tearDown() async throws {
        ...
        CrashReporter.shared.clearAllReports()
        CrashReporter.shared.clearOperationalIssues()
        CueLoopCoreTestSupport.assertRemoved(reportsDirectory)
