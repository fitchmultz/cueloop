/**
 ...
 Does not handle:
 - UI-level conflict resolution (see CueLoopMacUITests).
 ...
 - Uses synthetic CueLoopTask data; actual file structure not required.
 */
...
@MainActor
final class ConflictDetectionTests: CueLoopCoreTestCase {
    var workspace: Workspace!
    
    override func setUp() async throws {
        try await super.setUp()
        workspace = Workspace(workingDirectoryURL: CueLoopCoreTestSupport.workspaceURL(label: "conflict-detection"))
    }
