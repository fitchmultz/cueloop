...
final class RetryHelperTests: CueLoopCoreTestCase {
    ...
    func test_transientFixtureRetryability_staysAlignedAcrossRetrySurfaces() {
        ...
        for fixture in fixtures {
            ...
            let collectedOutput = CueLoopCLIClient.CollectedOutput(
    ...
    func test_failureMessage_fallsBackToTrimmedStderrThenDefaultMessage() {
        let stderrOutput = CueLoopCLIClient.CollectedOutput(
            status: CueLoopCLIExitStatus(code: 1, reason: .exit),
            stdout: "",
        ...
        let emptyOutput = CueLoopCLIClient.CollectedOutput(
            status: CueLoopCLIExitStatus(code: 1, reason: .exit),
            stdout: "",
            stderr: " \n "
        )
