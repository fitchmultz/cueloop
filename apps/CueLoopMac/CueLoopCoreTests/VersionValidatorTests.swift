/**
 ...
 Does not handle:
 - Actual CLI execution (covered by CueLoopCLIClientTests).
...
final class VersionValidatorTests: CueLoopCoreTestCase {
    ...
    func test_semanticVersion_parseWithPrefix() {
        let version = VersionValidator.SemanticVersion(from: "cueloop 0.1.0")
        XCTAssertNotNil(version)
