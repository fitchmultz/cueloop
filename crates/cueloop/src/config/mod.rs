...
//! - Discover repository roots via `.cueloop/` or `.git/` markers.
//!
//! Not handled here:
...
pub use resolution::{
    ProjectRuntimeLayout, find_repo_root, global_config_path, project_config_path,
    project_runtime_dir, project_runtime_layout, resolve_done_path, resolve_from_cwd,
