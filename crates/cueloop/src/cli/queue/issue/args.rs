//! Clap argument types for `cueloop queue issue`.
//!
//! Purpose:
//! - Clap argument types for `cueloop queue issue`.
//!
...
/// Top-level arguments for `cueloop queue issue`.
#[derive(Args)]
...
/// Arguments for `cueloop queue issue publish`.
#[derive(Args, Clone)]
...
/// Arguments for `cueloop queue issue publish-many`.
#[derive(Args, Clone)]
#[command(after_long_help = "Examples:\n\
