...
"#;
        ...
        assert!(footer.contains("Generated by CueLoop"));
...
"#,
        ...
        assert!(merged.footer.unwrap().contains("Generated by CueLoop"));
    }
...
"#;
        ...
        assert!(reconstructed.contains("Generated by CueLoop"));
    }
