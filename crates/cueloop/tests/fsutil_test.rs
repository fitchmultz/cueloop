//! Purpose: thin integration-test hub for `cueloop::fsutil` contract coverage.
//!
//! Responsibilities:
...
//!
//! Scope:
//! - Integration tests for the public `cueloop::fsutil` facade only.
//!
//! Usage:
