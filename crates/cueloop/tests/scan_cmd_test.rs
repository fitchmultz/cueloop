...
use cueloop::commands::scan as scan_cmd;
use cueloop::contracts::{GitRevertMode, Model, Runner, RunnerCliOptionsPatch};
...
fn test_scan_options_all_reasoning_efforts() {
    let efforts = vec![
        None,
        Some(cueloop::contracts::ReasoningEffort::Low),
        Some(cueloop::contracts::ReasoningEffort::Medium),
        Some(cueloop::contracts::ReasoningEffort::High),
        Some(cueloop::contracts::ReasoningEffort::XHigh),
    ];
